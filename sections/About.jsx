    ...
    >
      ...
      className="mt-[8px]  font-normal sm:text-[32px] text-[20px] text-center text-secondary-white">
        <span className="font-extrabold text-white">Metaverse </span>
         is a new thing in the future, where you can enjoy the virtual world feeling it's like it's really real, you can feel what you feel in this metaverse world, because this is really the 
      ...
      src="/arrow-down.svg" 
      alt="arrow down"
      className="w-[18px] h-[28px] object-conatin mt-[28px] "
      />
    </motion.div>
  </section>
);
